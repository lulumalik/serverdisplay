  ...
  methods: {
    ...
    changeSelected() {
      ...
      this.$store.commit('displayWidget/mutationWidget', {
        key: this.idTemplate + '_WidgetForecastStick_province',
        value: this.province,
      })
      this.getProvinsi()
    },
    changeSelectedKotkab() {
      this.$store.commit('displayWidget/mutationWidget', {
        key: this.idTemplate + '_WidgetForecastStick_kotkab',
        value: this.kotkab,
      })
      this.getKecamatan()
    },
    changeSelectedKecamatan() {
      this.$store.commit('displayWidget/mutationWidget', {
        key: this.idTemplate + '_WidgetForecastStick_kecamatan',
  ...
  async mounted() {
    if (
      this.$store.state.displayWidget.widgetSaved[
        this.idTemplate + '_WidgetForecastStick_province'
      ]
    ) {
      this.province =
        this.$store.state.displayWidget.widgetSaved[
    ...
    if (
      this.$store.state.displayWidget.widgetSaved[
        this.idTemplate + '_WidgetForecastStick_kotkab'
      ]
    ) {
      this.kotkab =
        this.$store.state.displayWidget.widgetSaved[
    ...
    if (
      this.$store.state.displayWidget.widgetSaved[
        this.idTemplate + '_WidgetForecastStick_kecamatan'
      ]
    ) {
      this.kecamatan =
        this.$store.state.displayWidget.widgetSaved[

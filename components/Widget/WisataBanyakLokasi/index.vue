  ...
  <div class="w-full">
    ...
    <div class="grid grid-cols-2 w-full gap-4">
      <div
        v-for="data in 4"
        :key="data"
        class="rounded-md bg-white/80 p-8 shadow-md"
      >
        <div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              class="text-4xl mt-2 pt-2  mb-3"
            >{{returningTimeZone(new Date(listWisata['kecamatan' + data][i].date)).split(' ')
              .splice(4, 4)[0]
              .split(':')
              .splice(0, 2)
            ...
            <div class="flex space-x-6 items-end">
              <div class="text-2xl">
                <div class="flex-grow relative w-32 h-16">
                  &nbsp;
                  <img
                    :src="'/Archive/' + listWisata['kecamatan' + data][i].weather_code + '.gif'"
                    class="w-32 absolute -top-8"
                    alt="imgdata"
                  />
                </div>
              </div>
              <div class="text-6xl">{{listWisata['kecamatan' + data][i].temp}}<sup>o</sup>C</div>
            </div>
          </div>
        </div>
      </div>
